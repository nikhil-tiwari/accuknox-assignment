...
import { addWidget } from "../redux/slices/cspm";
  ...
  return (
    <div className="p-8">
      <div className="flex items-center justify-between">
        <h2 className="text-lg font-medium">CSPM Executive DashBoard</h2>
        <button
      ...
      <div className="flex gap-4 items-center mt-2 overflow-auto px-4">
        {cspmWidget.length === 0 ? (
          <p>No widget added</p>
            ...
            cspmWidget.filter((widget) => !widget.checked).map((widget, index) => (
              <div
                key={index + 1}
